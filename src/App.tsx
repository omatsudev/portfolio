...
const projects = [
  ...
  {
    name: "MiniApps — Luizalabs",
    tagline: "Backend do SuperApp da Magazine Luiza",
    description: "Serviço backend crítico do SuperApp da Magazine Luiza. Responsável pela administração do ciclo de vida dos miniapps, gerenciamento de APIs, versionamento e distribuição para milhões de usuários.",
    url: "https://github.com/omatsudev",
    tags: ["Node.js", "TypeScript", "Fastify", "MySQL", "Redis", "OpenTelemetry"],
  ...
  {
    name: "Painel MiniApps — Luizalabs",
    tagline: "Dashboard admin do SuperApp",
    description: "Painel administrativo Next.js para gestão e monitoramento dos miniapps do SuperApp Magalu. Controles de visibilidade, atualização de versões, métricas e logs em tempo real.",
    url: "https://github.com/omatsudev",
...
const experiences = [
  {
    company: "Jaya Tech → Luizalabs (Magazine Luiza)",
    role: "Desenvolvedor Node.js | TypeScript | React | Next.js",
    period: "Nov 2022 — Presente · 3 anos",
    location: "São Paulo, SP · Remoto",
    logo: "MG",
    color: "bg-blue-600",
    bullets: [
      "Atuação no Squad Tools & MiniApps do SuperApp Magalu — um dos maiores super apps do Brasil",
      "Desenvolvimento e manutenção de microsserviços críticos em Node.js + TypeScript com Fastify, garantindo alta disponibilidade",
      "Gerenciamento e otimização de APIs com Apigee, Kong e Azion para controle de tráfego e segurança em produção",
      "Observabilidade e monitoramento com Instana e OpenTelemetry, assegurando SLAs do sistema",
      "Desenvolvimento frontend com React e Next.js para interfaces fluidas e responsivas no SuperApp",
      "Cobertura robusta de testes unitários e de integração com Jest em ambiente de alta criticidade",
    ],
    tags: ["Node.js", "TypeScript", "Fastify", "React", "Next.js", "Apigee", "Kong", "OpenTelemetry", "Jest"],
  },
  {
    company: "TO Brasil",
